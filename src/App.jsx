...
const EO_AGENCY_OPTIONS = [
  ...
  'ВП № 2 Краматорського РУП ГУНП в Донецькій області',
...
const ACT_SIGNER_OPTIONS = [
  ...
  'Старший інспектор ВЗВ № 1 УВТС ГУНП в Днецькій області, лейтенант поліції Олег ВАЛЯЄВ',
  'Старший інспектор ВЗВ № 2 УВТС ГУНП в Донецькій області, майор поліції Микола БАБАНОВ',
]
...
const EO_SIGNER_OPTIONS = [
  ...
  'Начальник ВП № 2 Краматорського РУП ГУНП в Донецькій області, підполковник поліції Дмитро СОЛОМІНЦЕВ',
